...
import { GlobalContextProvider } from '@island.is/tax/context'
import { OrganizationPage } from '@island.is/tax/graphql/schema'
import { getBackgroundStyle } from '@island.is/tax/utils/organization'
